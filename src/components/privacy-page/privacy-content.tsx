			...
			<Flex
				...
				<Flex flexDir="column" w="100%">
					...
					<Flex
						...
						/>
						<Flex mt="2rem" flexDir="column" w={{ base: "100%", lg: "40%" }}>
							<Text
			...
			<Flex
				...
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<UnorderedList my="1.2rem">
						...
						<ListItem>
							When it is in our legitimate interest ie there is a business or
							commercial reason to do so, unless this is outweighed by your
							rights or interests
						</ListItem>
						<ListItem>
							When you consent to it: we will always ask for your consent to
							hold and use health and medical information.
						</ListItem>
					</UnorderedList>
					...
					<UnorderedList my="1.2rem">
						...
						<ListItem>
							Suppliers of our website Alan Rogers, Customology
						</ListItem>
					</UnorderedList>
					<Text>
						We have rigorous data protection and security policies in place with
						all our suppliers.
					</Text>
					<Text mt="1.2rem">
						We will not share your information with any other third party
						without your consent except to help prevent fraud, or if required to
						do so by law.
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">
						We would like to send you information about products and services
						which may be of interest to you. We will ask for your consent to
						receive marketing information.
					</Text>
					<Text mt="1rem">
						If you have consented to receive marketing, you may opt-out at a
						later date.
					</Text>
					<Text mt="1rem">
				...
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">
						The information we collect about employees, the purposes it is used
						for and who it will be shared with is set out in our employment
						contracts and employee handbook.
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					<Text
					...
					<Text mt="1rem">
						Unless you request otherwise, we will keep your information to
						contact you for a maximum of 1 year from your last visit to the
						salon.
					</Text>
					<Text mt="1rem">
						After a year we will delete all your personal information, except
						for your name, relevant client history (eg allergy test records
						which we keep for 4 years) and financial transactions (which we are
						obliged to keep for 6 years).
					</Text>
					<Text mt="1rem">
						Information about unsuccessful job applicants will be deleted after
						four months.
					</Text>
					<Text mt="1rem">
						See our data retention policy for further information, including
						employee data.
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
				...
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">
						...
						that we hold about you. This will normally be free, unless we
						consider the request to be unfounded or excessive, in which case we
					...
					<Text mt="1rem">
						You have the right to ask us to object to our use of your personal
						information, or to ask us to delete, remove or stop using your
						personal information if there is no need for us to keep it.{" "}
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					<Text
					...
					<Text mt="1rem">
						Our website includes links to other websites. This privacy notice
						only applies to this website so when you link to other websites you
						should read their own privacy notices.
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					<Text
					...
					<Text mt="1rem">
						...
						any updates on this web page. This privacy notice was last updated
						on 09/05/2018
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<UnorderedList my="1.2rem">
						...
						<ListItem>
							Or write to us at Janet Brunskill, Flapex Beauty Ltd, 20 Bradford
							Road, Brighouse, HD6 1RW.
						</ListItem>
					</UnorderedList>
					<Text mt="1rem">
				...
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">We hold personal information about:</Text>
					<UnorderedList mb="1.2rem">
					...
					<Text mt="1rem">
						...
						these eg services or treatments provided, products bought, payroll
						information.
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">
						Unless requested by an individual, the following types of data will
						be held for the periods shown below, after which it will be securely
				...
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">
						Employee records, contracts of employment, changes to terms and
						conditions, annual leave, training records – While employment
						continues and up to 6 years after employment ends
					</Text>
					<Text mt="1rem">
						Payroll and wage records including PAYE, income tax, national
						insurance, sick pay, redundancy payments – 6 years from the
						financial year-end in which payments were made
					</Text>
					<Text mt="1rem">
						Maternity records – 3 years after the end of the tax year in which
						the maternity pay period ends
					</Text>
					<Text mt="1rem">
						Job applications (unsuccessful) – 4 months after notifying
						unsuccessful candidates
					</Text>
					<Text mt="1rem">
						Emails – One year from the end of the month in which they were
						received or sent unless a longer period is relevant as above
					</Text>
					<Text mt="1rem">
						Emails to and from ex-employees or contractors will be deleted
						within 2 weeks of them leaving unless these form part of the
						employment record – see above
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					<Text
					...
					<Text mt="1rem">
						Personal data about clients, financial transactions and employees
						are held on our secure salon software system which is backed up
						every day or held in secure electronic files electronically which
						can be accessed only by Janet Brunskill.
					</Text>
					<Text mt="1rem">
						Paper records are held in a locked cabinet or room or in secure
						archive storage.
					</Text>
				</Flex>
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">
						Personal data is permanently deleted in accordance with the
						retention periods listed above from:
					</Text>
					<UnorderedList>
				...
				<Flex w="100%" flexDir="column" mt="3rem">
					...
					<Text mt="1rem">See our privacy notice above.</Text>
					<Text mt="1rem">
						All requests for access to personal information will be handled by
						Janet Brunskill.
					</Text>
					<Text mt="1rem">
					...
					<Text mt="1rem">
						All information relating to the individual will be compiled into a
						report and collected from:
					</Text>
					<UnorderedList>
						<ListItem>Salon software system</ListItem>
