		...
		<>
			<Flex
				...
				<Flex flexDir="column" w="100%">
					...
					<Flex w="100%" h="25rem" mt="0.4rem" justify="space-between">
						<Flex mt="2rem" flexDir="column" w="45%" justify="space-between">
							<Text>
			...
			<Flex flexDir="column" px="15%" w="85%" bgColor="white">
				...
				<Flex w="100%" flexDir="column" mt="3rem">
                    ...
                    <Text my="1rem">This website & its content is copyright of <Box as="span" fontWeight="bold">Flapex Beauty Ltd – © Flapex Beauty Ltd</Box>. All rights reserved.
                    </Text>
					<Text>
				...
				<Flex w="100%" flexDir="column" mt="3rem">
                    ...
                    <Text mt="1rem">
                        The information contained in this website is for general information purposes only. The information is provided by <Box as="span" fontWeight="bold">Flapex Beauty Ltd</Box> & while we endeavour to keep the information up to date & correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose. Any reliance you place on such information is therefore strictly at your own risk.
                    </Text>
                    <Text mt="1rem">
                        In no event will we be liable for any loss or damage including without limitation, indirect or consequential loss or damage, or any loss or damage whatsoever arising from loss of data or profits arising out of, or in connection with, the use of this website.
                    </Text>
                    <Text mt="1rem">
                        Through this website you are able to link to other websites which are not under the control of <Box as="span" fontWeight="bold">Flapex Beauty Ltd.</Box> We have no control over the nature, content & availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.
                    </Text>
                    <Text mt="1rem">
                        Every effort is made to keep the website up & running smoothly. However, <Box as="span" fontWeight="bold">Flapex Beauty Ltd</Box> takes no responsibility for, & will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.
                    </Text>
